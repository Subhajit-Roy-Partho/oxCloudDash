...
export const ANALYSIS_OPTIONS: AnalysisOption[] = [
    {
        ...
        files: [{ name: "configuration", label: "Configuration File", description: "The main trajectory file.", required: true }, { name: "otherFile1", label: "Reference Configuration", description: "The reference frame to align to.", required: true }],
    ...
    },
    {
        ...
        files: [{ name: "configuration", label: "Configuration File", description: "Input configuration.", required: true }],
        params: [
    ...
    },
    {
        ...
        files: [{ name: "topology", label: "Topology File", description: "The system topology.", required: true }, { name: "configuration", label: "Configuration File", description: "The main trajectory file.", required: true }],
    ...
    },
    {
        ...
        files: [
            ...
            { name: "configuration", label: "Configuration File", description: "The main trajectory file.", required: true },
    ...
    },
    {
        ...
        files: [{ name: "configuration", label: "Configuration File", description: "The main trajectory file.", required: true }],
        params: [
    ...
    },
    {
        ...
        files: [{ name: "topology", label: "Topology File", required: true, description: "" }, { name: "configuration", label: "Configuration File", description: "The main trajectory file.", required: true }],
        params: [{ name: "min_length", backendName: "int1", type: "number", label: "Min Length" }],
    },
    { value: 14, command: "file_info", label: "File Info", description: "Prints metadata about trajectories.", files: [{ name: "configuration", label: "Configuration File", required: true, description: "" }], params: [] },
    {
    ...
    },
    {
        ...
        files: [
            ...
            { name: "configuration", label: "Configuration File", required: true, description: "" },
    ...
    },
    {
        ...
        files: [{ name: "configuration", label: "Configuration File", required: true, description: "" }],
        params: [
    ...
    },
    {
        ...
        files: [{ name: "topology", label: "Topology File", required: true, description: "" }, { name: "configuration", label: "Configuration File", required: true, description: "" }],
