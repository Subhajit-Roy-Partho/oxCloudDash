...
export const API_BASE_URL_INTERNAL = '/api/internal';
...
export const ANALYSIS_OPTIONS: AnalysisOption[] = [
    ...
    { value: 14, command: "file_info", label: "File Info", description: "Prints metadata about trajectories.", files: [{ name: "configuration", label: "Trajectory/Configuration File", required: true, description: "" }], params: [] },
    {
